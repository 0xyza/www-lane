...
const projectData = [
    ...
    },
    {
        id: "2",
        title: "Pathway",
        link: "https://pathway.chrstnl.com/",
        logo: pathwayIcon,
                ...
                <MotionBTTContainer transition={{ delay: 0.2, duration: 0.5 }}>
                    <SectionContainer className="hero--container flex flex-col gap-8 mt-32">
                        <Image
                            ...
                            className="rounded-full h-32 w-32 bg-neutral-100 object-cover p-4"
                            width={128}
                            height={128}
                        ...
                        <div className="content-container">
                            ...
                            <div className="content text-3xl md:text-3xl font-medium leading-8 lg:leading-10 tracking-tight lg:tracking-tighter text-neutral-500 ">
                               I&apos;m a theme that shows how you can create a personal blog and showcase your projects using this starter.
                            </div>
                        </div>
                    </SectionContainer>
                </MotionBTTContainer>
                            ...
                            {projectData.map((project) => (
                                ...
                                >
                                    ...
                                    <CardBody>
                                        <CardImage
                                            src={project.logo}
                                            alt="Alternative text for Logo Provided"
                        ...
                        <ul className="list-none space-y-5">
                            {posts.map((post) => (
                                ...
                                >
                                    <Link
                                        href={`/blog/${post.slug}`}
                                        className="block w-full card-clip p-8 no-underline sm:flex-row sm:gap-8 bg-neutral-50 rounded-[40px] transition-all duration-300 relative hover:-top-0.5"
                                    >
